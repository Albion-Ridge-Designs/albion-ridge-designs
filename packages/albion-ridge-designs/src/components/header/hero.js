        ...
        <div ref={element}>
          {isFontLoaded && textsArr.length > 0 &&
            <Flex direction="column" height="100vh" justifyContent="center" alignItems="center">
                ...
                <Flex direction="column" justifyContent="center" alignItems="center" border="5px solid black" borderRadius="30px" bg="brand.900" opacity="80%" pt={5} pb={5} minWidth={{base: "375px", sm: "475px", md: "500px"}}>
